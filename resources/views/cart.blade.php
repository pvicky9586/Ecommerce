...
@section('content')
    <div class="container" style="margin-top: 80px">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="/">go back to Shopping</a></li>
                        ...
                        <div class="col-lg-4">
                            <div class="row">
                                ...
                                <form action="{{ route('cart.remove') }}" method="POST">
                                    {{ csrf_field() }}
                                    <input type="hidden" value="{{ $item->id }}" id="id" name="id">
                                    <button class="btn btn-danger btn-sm" style="margin-right: 10px;" title="Cancelar"><span class="glyphicon glyphicon-trash"></span></button>
                                </form>
                            </div>
                        </div>
                    </div>
